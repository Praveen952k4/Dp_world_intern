 <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 60px; width: 130px;" src="companyimages/logo.jpg" alt="logo"></a>
    <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img style="height: 30px; width: 80px;" src="companyimages/logo.jpg" alt="logo" /></a>
  </div>
        ...
        { 
          ...
          <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
            <div class="nav-profile-img">
              ...
              { 
                ?>
                <img class="img-avatar" src="companyimages/karthi.jpg" alt="">
                <?php 
              } else { 
                ?>
                <img class="img-avatar" src="companyimages/karthi.jpg" alt=""> 
